...
class AppTheme {
  ...
  static Color color2(BuildContext context, String style, String tema) {
    // Encontrar el tema del dispositivo
    final Brightness brightness = MediaQuery.of(context).platformBrightness;
    final bool isDarkMode = brightness == Brightness.dark;
  ...
  static ButtonStyle button(String style) {
  ...
  //funcion que retorna los colores de la app
  ...
  static TextStyle style(String style) {
    final context = navigatorKey.currentContext!;
    // Encontrar el tema del dispositivo
    final Brightness brightness = MediaQuery.of(context).platformBrightness;
    final bool isDarkMode = brightness == Brightness.dark;
